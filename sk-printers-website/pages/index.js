          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <a href="#calculator" className="btn bg-white text-primary-700 hover:bg-gray-100 text-lg px-8 py-4 text-center">
                  Get Instant Quote
                </a>
                <Link href="/products">
                  <a className="btn border-2 border-white text-white hover:bg-white hover:text-primary-700 text-lg px-8 py-4 text-center">
                    View Products
                  </a>
                </Link>
              </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {products.map((product, index) => (
              ...
              >
                ...
                <Link href="/products">
                  <a className="btn btn-outline w-full group-hover:bg-primary-600 group-hover:text-white">
                    Learn More
                  </a>
                </Link>
              </motion.div>
      ...
      <section className="section-padding bg-gradient-to-r from-primary-600 to-primary-800 text-white">
        <div className="container-custom text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/get-quote">
              <a className="btn bg-white text-primary-700 hover:bg-gray-100 text-lg px-8 py-4">
                Request a Quote
              </a>
            </Link>
            <Link href="/contact">
              <a className="btn border-2 border-white text-white hover:bg-white hover:text-primary-700 text-lg px-8 py-4">
                Contact Us
              </a>
            </Link>
          </div>
